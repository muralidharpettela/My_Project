...
#C:\Users\pettm\Downloads\Audi_dataset\14_may_2018\AU334_PVS_GesFzg_20140721072917\Elektrik\Testwoche_04,0
img_json_folder_path="C:\\Users\\pettm\\Downloads\\Audi_dataset\\14_may_2018\\AU334_PVS_GesFzg_20140721072917\\Elektrik\\Testwoche_00,0\\"

def run(im,json_old_path, img_name, length_basename, index_basename):
    coords=[]
    #im_disp = im.copy()
    im_draw = im.copy()
    #im_draw2=im.copy()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if key==SPACE:
            ...
            print("Saved to Elektrik")
            try:
                cv2.imwrite('C:\\Users\\pettm\\Desktop\\Data\\Elektrik\\'+str(name)+'.jpg',im)
                index_basename+=2
            except:
                print("DONE!!!")
        elif key==F:
            print("Saved to Elektrik_frontend_motorraum")
            try:
                cv2.imwrite('C:\\Users\\pettm\\Desktop\\Data\\Elektrik_Frontend_Motoraum\\'+str(name)+'.jpg',im) 
                index_basename+=2
            except:
                print("DONE!!!")
        elif key==S:
            print("Saved to Elektrik_Scheinwerfer_Blinker")
            try:
                 cv2.imwrite('C:\\Users\\pettm\\Desktop\\Data\\Elektrik_Scheinwerfer_Blinker\\'+str(name)+'.jpg',im) 
                 index_basename+=2
            except:
                print("DONE!!!")
        elif key==K:
            print("Saved to Elektrik_Kofferraum_Heckklappe")
            try:
                 cv2.imwrite('C:\\Users\\pettm\\Desktop\\Data\\Elektrik_Kofferraum_Heckklappe\\'+str(name)+'.jpg',im) 
                 index_basename+=2
            except:
                print("DONE!!!")
        elif key==BCKSPACE:
